        ...
        <div class="card border-left-primary shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto"><i class="fas fa-box fa-2x" style="color:#a09be7;"></i></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card border-left-success shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                   ...
                   <div class="col-auto"><i class="fas fa-users fa-2x" style="color:#d6ff79;"></i></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card border-left-info shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto"><i class="fas fa-money-bill-wave fa-2x" style="color:#a09be7;"></i></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="card border-left-warning shadow h-100 py-2">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="col-auto"><i class="fas fa-file-invoice fa-2x" style="color:#ff9191;"></i></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="col-xl-8 col-lg-7">
        <div class="card shadow mb-4">
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                ...
                <a href="<?= base_url('order') ?>" class="btn btn-sm" style="background-color:#d6ff79; color:#2d4a00; font-weight:700; border:none;">Lihat Semua</a>
            </div>
            <div class="card-body">
