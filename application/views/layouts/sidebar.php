...
<!-- Sidebar -->
<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background: linear-gradient(180deg, #5f00ba 0%, #3d007a 100%);">
...
<!-- Topbar -->
<nav class="navbar navbar-expand navbar-light topbar mb-4 static-top" style="background:#ffffff; border-bottom: 3px solid #5f00ba; box-shadow: 0 2px 15px rgba(95,0,186,0.1);">
            ...
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                    ...
                    <span class="badge badge-pill ml-1" style="background-color:<?= $role === 'admin' ? '#5f00ba' : ($role === 'manager' ? '#ff9191' : '#a09be7') ?>; color:<?= $role === 'manager' ? '#5a0000' : '#fff' ?>; font-weight:700;">
                        <?= strtoupper($role) ?>
                    </span>
                </span>
